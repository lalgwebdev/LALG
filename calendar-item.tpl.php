...
// **********  Make a Class label from the **************
$group_type = $item->rendered_fields['term_node_tid'];
$group_type = explode(" ", $group_type);
$group_type = 'group-type-' . strtolower($group_type[0]);		
?>

<?php //dpm($item, $name = NULL); ?>

<div class="<?php print !empty($item->class) ? $item->class : 'item'; ?>">
  <div class="view-item view-item-<?php print $view->name ?>">
  <div class="calendar <?php print $item->granularity; ?>view <?php print $group_type?> ">
